...
public class MainFrame extends JFrame implements ComponentListener {
    ...
    static JButton btnCircle, btnRect, btnGraph, btnClear;
    JSplitPane splitter;
    ...
    public MainFrame(String title) {
        ...
        JScrollPane workingScroller =
                new JScrollPane(
                        MainFrame.workingPanel,
        ...
        btnClear.addActionListener(workingPanel);
    }
